...
- 2026-09-23 operator ruling: claude-plugins owns the decision rules; decisions become their own plugin (see 7113). The research on 7113 runs first; 2b15 is planned from its findings in an interactive review.
