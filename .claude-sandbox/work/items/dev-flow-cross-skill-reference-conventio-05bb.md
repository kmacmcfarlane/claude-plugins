...
fix round 1 (opus): DONE 672e487 (python lint bound to the named sibling; directory paths flagged; .mdx; docs state backticked form).
dispatch: reviewer opus review round 2 — resume

review round 2 (opus): CLEAR. Lint edge lows carried to 07c3 F1 (the checklist moves there).
- 2026-09-19 done: e39b2c3
