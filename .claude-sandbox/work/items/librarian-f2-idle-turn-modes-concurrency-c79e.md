...
answer 68: hold — operator 2026-09-24: "I'm not so sure I want the librarian to eat quota until we switch to the scheduler that the `agents` repo is specing out in parallel"
