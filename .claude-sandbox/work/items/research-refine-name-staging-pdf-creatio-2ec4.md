...
From adef's CLEAR review: research-refine SKILL.md:60-78 writes its own brief and never names creating <staging>/pdf/ (it relies on run-record.md § Creating staging); add one clause beside its preflight line, and the same at research SKILL.md Step 5.5. Also research SKILL.md:243 is 153 columns; wrap to ~92. Mechanical (sonnet), prose in skills keeps a reviewer.
