...
- **A store-less run, re-invoked in a new session, finds a worktree or branch the old one
  left.** S0b: not resumable from this session — report it and stop; the orphan-worktree
