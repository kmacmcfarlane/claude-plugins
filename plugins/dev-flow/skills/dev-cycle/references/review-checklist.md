...
- [ ] The frontmatter parses under a strict YAML parser, and `name`, `description` and
      ...
      the skill without a word. Quote `argument-hint` whenever it is present. The
      strict-YAML block at the end of this section checks it; a `SKIP` there is a gap to
      report, not a pass.
