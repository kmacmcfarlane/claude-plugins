...
# of 5 is the operator's ruling (2026-09-24, the series' Open Question 3): no
# intent's five-hour reserve goes below 5. The other values stay the series'
# provisional defaults pending ratification (away's five-hour reserve is 10, per
# its resolution of 1222's F1/F5 split).
RESERVES = {
    "present": (25.0, 15.0),
    "away": (10.0, 15.0),
