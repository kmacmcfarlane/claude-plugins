...
the final Report. Send that final Report last, so it reports the push as well as the
landings. The context-gate ledger and HANDOFF are session-addressed and do not replace
this; the librarian rehydrates from `wi prime` and git.
