...
put every decision to the operator per that skill (its content floor, levels, order, echo
and read-back); without it they use their own numbered list, options with their impact,
